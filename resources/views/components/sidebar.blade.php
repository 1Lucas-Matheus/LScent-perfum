@section('sidebar')
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen bg-white border-r border-gray-200 dark:bg-gray-900 dark:border-gray-700 transition-transform -translate-x-full sm:translate-x-0">
    <div class="h-full flex flex-col justify-between p-4 overflow-y-auto">
        <div>
            ...
            <ul class="space-y-2 text-sm font-medium text-gray-700 dark:text-gray-200">
                <li>
                    <a href="{{ route('dashboard') }}" class="flex items-center p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                ...
                <li>
                    <a href="{{ route('products.index') }}" class="flex items-center p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                ...
                <li>
                    <a href="{{ route('categories.index') }}" class="flex items-center p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                ...
                <li>
                    <a href="{{ route('coupons.index') }}" class="flex items-center p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                ...
                <li>
                    <a href="#" class="flex items-center p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                        <svg class="w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-indigo-500" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
        ...
        <ul class="space-y-2 pt-4 border-t border-gray-300 dark:border-gray-600">
            <li>
                <form id="logout-form" action="{{ route('logout') }}" method="POST" class="hidden">@csrf</form>
                <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="flex items-center p-2 text-red-600 hover:bg-red-100 dark:hover:bg-red-900 rounded-lg transition">
