...
<body class="flex min-h-screen bg-white">
    ...
    <div class="flex items-center justify-center w-full min-h-screen p-4 sm:ml-64 bg-gray-50">
        <div class="bg-white w-full max-w-md flex flex-col rounded-lg px-10 py-8 shadow-[10px_10px_30px_rgba(0,0,0,0.1)]">
            <h1 class="mb-6 text-3xl font-semibold text-center text-gray-900">Atualizar cupom</h1>
            ...
            <form action="{{ route('coupons.update', ['coupom' => $coupom->id]) }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="key" name="key" placeholder="Exemplo: qWuPi-roS5cY" class="w-full py-2 pl-10 pr-3 text-sm border rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ $coupom->key }}" required>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" min="1" max="100" id="value" name="value" placeholder="Exemplo: 50" class="w-full py-2 pl-10 pr-3 text-sm border rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ $coupom->value }}" required>
                    </div>
                </div>
                ...
                <div class="space-y-3">
                    <p class="text-sm font-medium text-gray-700">Gerar nova chave de ativação</p>
