    ...
    <div class="flex flex-col justify-between h-full p-4 overflow-y-auto">
        ...
        <ul class="pt-4 space-y-2 border-t border-gray-300 dark:border-gray-600">
            <li>
                ...
                <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="flex items-center p-2 text-red-600 transition rounded-lg hover:bg-red-100 dark:hover:bg-red-900">
